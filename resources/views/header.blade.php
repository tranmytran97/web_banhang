		...
		<div class="container">
			<div class="pull-left auto-width-left">
				<ul class="top-menu menu-beta l-inline">
					<li><a href=""><i class="fa fa-home"></i>104 Trần Kế Xương Quận Phú Nhuận</a></li>
					<li><a href="tel:+84972939830"><div class="hotline">
...
<span class="hotline-number">0972.939.830</span>
			...
			<div class="pull-right auto-width-right">
				<ul class="top-details menu-beta l-inline">
					...
					@else
						<li><a href="{{route('signin')}}"><i class="glyphicon glyphicon-user"></i>Đăng kí</a></li>
	...
	<div class="header-body">
		<div class="container beta-relative">
			<div class="pull-left">
				<a href="{{route('trang-chu')}}" id="logo"><img src="source/image/product/logo_mobile1.jpg" width="300px" alt=""></a>
			</div>
					...
					<div class="cart">
						...
						<div class="beta-dropdown cart-body">
								...
								@foreach($product_cart as $product)
									...
									<div class="cart-item">
										<a class="fa fa-trash" href="{{route('xoagiohang',$product['item']['id'])}}"><i class="fa fa-times"></i></a>
										<div class="media">
