							...
							<ul class="payment_methods methods">
								...
								<li class="payment_method_cheque">
									...
									<div class="payment_box payment_method_cheque" style="display: none;">
										...
										<br>- Chủ TK: Trần Mỹ Trân
										<br>- Ngân hàng BIDV, Chi nhánh TPHCM
									</div>
										<div style="margin: 0 auto; width: 500px;">
	<h3 style="margin-bottom: 20px;"><span class="label label-primary">Thanh toán trực tuyến</span></h3>
				...
				<tr>
					...
					<td>
						<select name="card_type_id" style="width: 390px;border: 1px solid #ccc;height: 30px;">
							...
							<option value="4">VPbank</option>
							<option value="6">ViettinBank</option>
							<option value="7">DongABank</option>
